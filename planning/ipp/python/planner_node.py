...
"""
Summary: Interfaces with ROS master. Collects parameters from 
parameter server, makes rudimentary checks on parameters,
then initializes planner object to run in ROS thread.
"""
...
if __name__ == "__main__":
    ...
    try:        
        ...
        # Run bayesian optimization based planner 
            ...
            planner = BayesianPlannerClass.BOPlanner(corner_topic=corner_topic, path_topic=path_topic, 
